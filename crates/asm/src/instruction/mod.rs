...
pub trait InstructionMeta: Display + Debug + Clone + Copy + PartialEq + EqTrait + Hash {
    ...
    /// # Example
    /// ```
    /// # use oculars_asm::{opcode::{OpCode, Mnemonic}, instruction::{Unknown, Gas, InstructionMeta}};
    ...
    /// # Example
    /// ```
    /// # use oculars_asm::instruction::{Push, Gas, InstructionMeta};
    ...
    /// # Example
    /// ```
    /// # use oculars_asm::instruction::{Dup, Gas, InstructionMeta};
    ...
    /// # Example
    /// ```
    /// # use oculars_asm::instruction::{Swap, Gas, InstructionMeta};
    ...
    /// # Example
    /// ```
    /// # use oculars_asm::instruction::{Log, Gas, InstructionMeta};
    ...
    /// # Example
    /// ```
    /// # use oculars_asm::instruction::{Return, Unknown, Gas, InstructionMeta};
